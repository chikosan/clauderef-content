...
require maintainer approval. After a content change is merged, the private website repository
imports the reviewed snapshot through a separate pull request, then deploys the verified app commit
through Coolify.
